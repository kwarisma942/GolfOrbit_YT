namespace PaperPlaneTools 
{
	...
	public interface IAlertPlatformAdapter 
	{
		...
		/// <summary>
		/// Used to manually invoke the negative button if needed
		/// </summary>
		void InvokeNegativeButton ();


		/// <summary>
		/// Used to manually invoke the neutral button if needed
		/// </summary>
		void InvokeNeutralButton ();
