...
void _playOnForceGdprApply(bool isApplied){
    [PlayOnManager.sharedManager forceGdprApply:isApplied];
}

void _playOnForceCcpaApply(bool isApplied){
    [PlayOnManager.sharedManager forceCcpaApply:isApplied];
}
