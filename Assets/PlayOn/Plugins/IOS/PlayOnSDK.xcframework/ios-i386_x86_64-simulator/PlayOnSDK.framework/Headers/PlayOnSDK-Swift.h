...
#ifndef PLAYONSDK_SWIFT_H
#define PLAYONSDK_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="PlayOnSDK",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
# pragma pop_macro("any")
#endif


SWIFT_CLASS("_TtC9PlayOnSDK14ConsentService")
@interface ConsentService : NSObject
SWIFT_CLASS_PROPERTY(@property (nonatomic, class, readonly, strong) ConsentService * _Nonnull shared;)
+ (ConsentService * _Nonnull)shared SWIFT_WARN_UNUSED_RESULT;
@property (nonatomic) BOOL isForceGdprApplied;
@property (nonatomic) BOOL isForceCcpaApplied;
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
@end

@class NSString;

@interface ConsentService (SWIFT_EXTENSION(PlayOnSDK))
@property (nonatomic) BOOL isGdprApplied;
@property (nonatomic) BOOL isCcpaApplied;
...
SWIFT_CLASS("_TtC9PlayOnSDK17SilentModeService")
@interface SilentModeService : NSObject
/// Shared instance
SWIFT_CLASS_PROPERTY(@property (nonatomic, class, readonly, strong) SilentModeService * _Nonnull shared;)
+ (SilentModeService * _Nonnull)shared SWIFT_WARN_UNUSED_RESULT;
