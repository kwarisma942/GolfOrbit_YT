...
IL_004a:
	...
	}
	{
		...
		int32_t L_21 = V_2;
		DiagnosticEvent_t33E1175DA005D137D20535AB25ACE16837A3A274 L_22 = ((L_20)->GetAddressAtUnchecked(static_cast<il2cpp_array_size_t>(L_21)))->___value;
...
IL_0035:
	{
		...
		V_1 = L_10;
		int32_t L_11 = V_1;
		Dictionary_2_Resize_mBA7A5565D7BDF3C30C253F8DEFC5A8288BCFF438(__this, L_11, (bool)0, il2cpp_rgctx_method(method->klass->rgctx_data, 56));
		int32_t L_12 = V_1;
		return L_12;
	}
}
